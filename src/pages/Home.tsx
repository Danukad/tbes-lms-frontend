        ...
        <>
            <div className="w-full min-h-[100vh] bg-[#02051B] flex flex-col items-center justify-center overflow-hidden pt-16 sm:pt-20 md:pt-24">
                ...
                <img
                    ...
                    className="absolute top-0 left-0 w-full max-w-[700px] pointer-events-none z-0 sm:right-[-10%] md:right-[10%] lg:right-[20%] xl:right-[25%] 2xl:right-[30%]"
                />
                <img
                    src={backsquare}
                    alt="Decorative square pattern"
                    className="w-full absolute top-0 opacity-5 z-10"
                />
                    ...
                    <div className="h-6 xs:h-7 sm:h-8 lg:h-9 rounded-xl bg-[#02051B] flex items-center justify-center space-x-1 px-1 xs:px-2">
                        {currentImages.map((img, i) => (
                            <img
                                key={i}
                                src={img}
                                alt={`Reviewer ${i + 1} profile`}
                                className="inline-block w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 rounded-full object-cover"
                                style={{ boxShadow: 'inset 0 0 6px 2px rgba(255,255,255,0.3)' }}
                            />
                        ))}
