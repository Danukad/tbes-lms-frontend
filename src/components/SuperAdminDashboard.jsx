...
const SuperAdminDashboard = () => {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-[#364CE2] to-[#010D60] font-inter">
                ...
                <div className="w-64 bg-[#010D60] p-6 h-screen sticky top-0">
                    ...
                    <nav className="space-y-2">
                        ...
                        {userRole === 'superadmin' && (<>
                                ...
                                <button onClick={() => setActiveTab('module-manager')} className={`w-full text-left py-3 px-4 rounded-lg ${activeTab === 'module-manager'
            ...
            }} className={`w-full text-left py-3 px-4 rounded-lg text-white hover:bg-[#C9A500] hover:text-black`} value="">
