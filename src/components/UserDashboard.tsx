...
const UserDashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-[75vh] xs:min-h-[80vh] sm:min-h-[85vh] bg-gradient-to-br from-[#364CE2] to-[#010D60] text-white font-['Montserrat',sans-serif] p-4 xs:p-4 sm:p-6">
            {loading && <div className="text-center text-base xs:text-lg sm:text-xl">Loading dashboard...</div>}
            {!loading && (
                <div className="max-w-[90vw] xs:max-w-[92vw] sm:max-w-[1000px] md:max-w-[1200px] mx-auto">
                    ...
                    {profile && (
                        <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl p-4 xs:p-6 mb-6 xs:mb-8 shadow-lg">
                            <div className="flex items-center space-x-3 xs:space-x-4">
                                <img
                                    src="https://via.placeholder.com/80"
                                    alt="Avatar"
                                    className="w-16 xs:w-20 h-16 xs:h-20 rounded-full border-2 border-[#C9A500]"
                                />
                                <div>
