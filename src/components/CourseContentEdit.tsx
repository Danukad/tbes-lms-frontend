...
const CourseContentEdit: React.FC = () => {
    ...
    const handleChange = (field: keyof CourseContent, index: number, value: string) => {
        setContent((prev) => {
    ...
    const addField = (field: keyof CourseContent) => {
        setContent((prev) => {
            const updated = Array.isArray(prev[field]) ? [...prev[field], ''] : [''];
            return { ...prev, [field]: updated };
        });
                ...
                <div className="mb-4">
                    ...
                    {content.stack.map((tech, index) => (
                        <input
                            ...
                            type="text"
                            value={tech}
                            onChange={(e) => handleChange('stack', index, e.target.value)}
                            className="border p-2 mb-2 w-full rounded"
                ...
                <div className="mb-4">
                    ...
                    {content.overview.map((item, index) => (
                        <input
                            ...
                            type="text"
                            value={item}
                            onChange={(e) => handleChange('overview', index, e.target.value)}
                            className="border p-2 mb-2 w-full rounded"
