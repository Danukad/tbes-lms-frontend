            ...
            <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl bg-white/30 shadow-xl rounded-[20px] p-6 sm:p-8 backdrop-blur-2xl border border-white/40">
                ...
                <form onSubmit={handleActivate} className="flex flex-col gap-4">
                    <div>
                        ...
                        <input
                            type="text"
                            value={activateData.uniqueID}
                            onChange={(e) => setActivateData({ ...activateData, uniqueID: e.target.value })}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setActivateData({ ...activateData, confirmPassword: e.target.value })}
                            className="w-full p-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required
                            disabled={isLoading}
                        />
                    ...
                    <button
                        ...
                        className={`w-full py-3 rounded-md font-bold text-white transition-all ${
                            isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#010D60] hover:bg-black'
                        }`}
                    >
