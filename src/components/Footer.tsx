...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-[#010D60] text-white py-8 xs:py-8 sm:py-10 md:py-12 overflow-hidden">
                    ...
                    <div>
                        ...
                        <form className="flex flex-col space-y-2 max-w-[90%] xs:max-w-[260px] sm:max-w-[300px]" onSubmit={handleSubmit} aria-label="Newsletter signup">
                            ...
                            <input
                                ...
                                className="px-3 xs:px-3 sm:px-4 py-1.5 xs:py-1.5 sm:py-2 rounded-md text-gray-800 text-sm xs:text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-[#C9A500]"
                                required
                            />
                            <button
                                type="submit"
                                className="bg-[#C9A500] text-white px-3 xs:px-3 sm:px-4 py-1.5 xs:py-1.5 sm:py-2 rounded-md hover:bg-[#A78A00] transition-colors text-sm xs:text-sm sm:text-base"
                            >
                                Subscribe
                            </button>
                        </form>
