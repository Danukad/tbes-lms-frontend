            ...
            <div className="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                {courses.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {courses.map((course) => (
                            <div key={course._id} className="p-4 bg-gray-50 rounded-md">
                ...
                <button
                    ...
                    className="mt-6 w-full max-w-xs mx-auto block bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700"
                >
                    Back to Dashboard
                </button>
            </div>
