        ...
        <div>
            ...
            <form onSubmit={handleAssignCourse} className="mb-8 grid gap-4 sm:grid-cols-2">
                <select
                    ...
                    onChange={(e) => setAssignForm({ ...assignForm, tutorId: e.target.value })}
                ...
                <button
                    type="submit"
                    className="bg-[#C9A500] text-black p-3 rounded-lg hover:bg-opacity-80 sm:col-span-2"
                >
                    Assign Course
                </button>
            </form>
            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse">
                    ...
                    <tbody>
                    {tutors.map((tutor: any) => (
                        <tr key={tutor._id} className="border-b hover:bg-gray-100">
            ...
            <div className="flex justify-between mt-4">
                <button
                    ...
                    disabled={page === 1}
                    className="px-4 py-2 bg-[#C9A500] text-black rounded-lg disabled:opacity-50"
                >
                    Previous
                </button>
